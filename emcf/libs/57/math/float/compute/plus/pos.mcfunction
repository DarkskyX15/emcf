...
scoreboard players operation __buf1__ __bd__ += __buf2__ __bd__
execute store result score __buf2__ __bd__ run data get storage __st__ cache.left.v
scoreboard players operation __buf1__ __bd__ -= __buf2__ __bd__
scoreboard players operation __gen__ __bd__ = __buf1__ __bd__

# 有效长度
scoreboard players operation __buf1__ __bd__ += __buf2__ __bd__
scoreboard players operation __buf4__ __bd__ = __buf1__ __bd__

scoreboard players set __cst__ __bd__ 9
scoreboard players operation __buf1__ __bd__ -= __cst__ __bd__

# 判断是否需要减少精度
execute if score __buf1__ __bd__ matches ..-1 run scoreboard players set __buf1__ __bd__ 0
scoreboard players operation __gen__ __bd__ -= __buf1__ __bd__

# 扩大常数
function math_pow10:entry
execute store result score __buf2__ __bd__ run data get storage __st__ cache.left.a
